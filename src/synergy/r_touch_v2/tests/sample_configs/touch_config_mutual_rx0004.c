...
static touch_common_parameter_t g_touch_cfg_on_g_ctsu_cfg_mutual0_common_parameter_rcv_00_04 =
{
    .drift_hold_limit = 50,
...
static touch_sensor_parameter_t g_touch_cfg_on_g_ctsu_cfg_mutual0_sensor_parameter_rcv_00_04[] =
{
...
uint8_t g_touch_cfg_on_g_ctsu_cfg_mutual0_binary_rcv_00_04[(10/8) + 1];

static uint8_t g_touch_cfg_on_g_ctsu_cfg_mutual0_buffer_rcv_00_04[320];

extern ctsu_instance_t const g_ctsu_mutual_rcv_00_04;

touch_cfg_t g_touch_cfg_on_g_ctsu_cfg_mutual0_rcv_00_04=
{
    .p_ctsu = &g_ctsu_mutual_rcv_00_04,
    .p_common = &g_touch_cfg_on_g_ctsu_cfg_mutual0_common_parameter_rcv_00_04,
    .p_sensor = (touch_sensor_parameter_t*)&g_touch_cfg_on_g_ctsu_cfg_mutual0_sensor_parameter_rcv_00_04,
    .p_binary_result = g_touch_cfg_on_g_ctsu_cfg_mutual0_binary_rcv_00_04,
    .p_callback = NULL,
    .num_ignored = 0,
    .p_ignored = NULL,
    .buffer = {
        .p_start = g_touch_cfg_on_g_ctsu_cfg_mutual0_buffer_rcv_00_04,
        .size = sizeof(g_touch_cfg_on_g_ctsu_cfg_mutual0_buffer_rcv_00_04),
    },
    .custom =
    {
        .p_filter = NULL,
